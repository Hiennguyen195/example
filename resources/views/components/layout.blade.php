            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img src="https://images.laracasts.com/series/thumbnails/png/lets-build-a-sass-with-laravel.png?tr=w-160" alt="Your Company" class="size-8" />
                        </div>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <button type="button" class="relative rounded-full p-1 text-gray-400 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">
                                ...
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
                                    <path d="m9 12.75 3 3m0 0 3-3m-3 3v-7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </button>
                            ...
                            <el-dropdown class="relative ml-3">
                                <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                    ...
                                    <img src="https://images.laracasts.com/series/thumbnails/png/react-from-scratch.png?tr=w-160" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                                    <!-- User name -->
                                    <span class="ml-2 text-sm font-medium text-gray-300 group-hover:text-white">Hien Nguyen</span>
                                </button>
                            </el-dropdown>
                        </div>
                    </div>
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img src="https://images.laracasts.com/series/thumbnails/png/react-from-scratch.png?tr=w-160" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                        </div>
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Hien Nguyen</div>
                            <div class="text-sm font-medium text-gray-400">hiennguyen@learnlaravel.laracasts</div>
                        </div>
